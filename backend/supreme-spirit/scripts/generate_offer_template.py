...
from database import Session, OfferTemplate
...
def generate_templates():
    ...
    deposit_1 = OfferTemplate(
        ...
        data={"description" : "Высокий доход даже"
             " с небольшой суммы вклада",
                "interest" : 5.7,
                "amount" :  15000}
        )
    ...
    deposit_2 = OfferTemplate(
        ...
        type=OfferType.DEPOSIT,
        data={"description" : "Регулярное получение"
            " дохода по высокой ставке",
                "interest" : 5.7,
                "amount" :   500000}
        )
    ...
    mortage_1 = OfferTemplate(
        ...
        data={"description" : "Широкий выбор квартир"
    ...
    mortage_2 = OfferTemplate(
        text="Готовое жилье",
        type=OfferType.MORTGAGE,
        data={"description" : "Купите столько"
    ...
    deposit_3 = OfferTemplate(
        ...
        type=OfferType.DEPOSIT,
        data={"description" : "Классический инструмент"
             " для свободного управления накоплениями",
                "interest" : 5.9,
                "amount" :  0}
        )
    db.add(credit_1)
