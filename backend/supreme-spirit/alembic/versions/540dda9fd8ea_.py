...
def upgrade():
    ...
    op.create_index(op.f('ix_offer_filters_offer_filter_id'), 'offer_filters', ['offer_filter_id'], unique=False)
    ...
    op.create_index(op.f('ix_offer_templates_offer_template_id'), 'offer_templates', ['offer_template_id'], unique=False)
    op.create_table('users',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('login', sa.String(length=50), nullable=False),
    sa.Column('address', sa.String(length=50), nullable=True),
    sa.Column('type', sa.Enum('OOO', 'ZAO', 'PAO', 'OAO', 'IP', name='usertype'), nullable=True),
    sa.Column('activity', sa.Enum('REAL_ESTATE', 'IT', 'HR', 'PUBLIC_ORGANIZATION', 'FOODSTUFFS', name='useractivity'), nullable=True),
    ...
    sa.Column('type', sa.Enum('CREDIT', 'DEPOSIT', 'PAYMENT', name='accounttype'), nullable=True),
